...
public class ModOptions
{
	...
	public static boolean enableLogPileMod = false;
	...
	// Mods - Log Piles
	public static boolean showGenericWood = false;
	...
	{	
		...
		// ModOptions.enableLogPileMod = ModOptions.getBooleanFor(config, "Mods", "enableLogPileMod", false, "Set this to true if you want to turn on the Substitute Log Piles Mod. ** NOTE: Turning this off will cause some items and blocks to be removed from your world.");
		...
		// Mods - Log Piles
		// ModOptions.showGenericWood = ModOptions.getBooleanFor(config, "LogPiles", "showGenericWood", true, "Set this to true to render log piles in a generic wood texture; otherwise false to render in the specific wood texture.");
	...
	public static void loadSettings(ModOptions options)
	{
		...
		// ModOptions.enableLogPileMod = options == null ? true : options.enableLogPileMod;
		...
		// Mods - Log Piles
		// ModOptions.showGenericWood = options == null ? false : options.showGenericWood;
