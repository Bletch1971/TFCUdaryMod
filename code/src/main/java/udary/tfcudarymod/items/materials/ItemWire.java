package udary.tfcudarymod.items.materials;
...
public class ItemWire extends ItemTerra implements ISmeltable
{
	...
	public ItemWire(ToolMaterial toolMaterial, int damage)
	{
		super();
	...
	public ItemWire setSmeltable(String metalName, short metalAmount, boolean smeltable, EnumTier smeltTier)
	{
	...
	public ItemWire setSmeltable(Metal metal, short metalAmount, boolean smeltable, EnumTier smeltTier)
	{
