package udary.tfcudarymod.items.fluids;
...
public class ItemGlassBottleMilk extends ItemGlassBottleFluid implements IFood
{
 	...
 	public ItemGlassBottleMilk()
	{
		...
		this.foodMaxWeight = ModFluids.GlassBottleMaxFoodWeight;
		this.tasteBitter = 0;
		this.tasteSalty = 0;
		this.tasteSavory = 10;
		this.tasteSour = 0;
	...
	{
		list.add(ModTags.applyFoodTag(new ItemStack(this), ModFluids.GlassBottleMaxFoodWeight));
	}
	...
	public void onUpdate(ItemStack is, World world, Entity entity, int i, boolean isSelected)
	{
		...
		{
			ModTags.applyFoodTag(is, ModFluids.GlassBottleMaxFoodWeight);
		}
	}
